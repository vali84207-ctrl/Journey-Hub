      ...
      <div className="container relative z-10 mx-auto px-6 py-32 text-center max-w-5xl">
        ...
        >
          ...
          <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl font-bold text-white leading-tight mb-6 drop-shadow-2xl">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-yellow-200 to-primary">Across Tajikistan</span>
          </h1>
          <p className="text-lg md:text-xl text-white/80 font-light mb-12 max-w-2xl mx-auto tracking-wide">
            Comfort. Safety. Luxury. Experience unhurried elegance with our exclusive fleet and professional chauffeurs.
          </p>
        </motion.div>
        ...
        >
          <Button 
            size="lg" 
            className="w-full sm:w-auto bg-primary text-primary-foreground hover:bg-primary/90 font-semibold tracking-wider uppercase px-12 py-7 text-sm rounded-none border border-primary hover:gold-glow transition-all"
