    ...
    <main className="min-h-screen bg-background text-white selection:bg-primary selection:text-black">
      ...
      <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0"
          style={{ background: "linear-gradient(180deg, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.20) 35%, rgba(0,0,0,0.85) 100%)" }}
        />
        <div className="absolute inset-0"
          style={{ background: "radial-gradient(ellipse at 60% 30%, rgba(221,184,95,0.10) 0%, transparent 55%)" }}
        />
        ...
        <div className="relative z-10 h-full flex items-end pb-16">
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            >
              <Link
                href="/blog"
                className="inline-flex items-center gap-2 text-white/70 hover:text-primary text-[10px] tracking-[0.3em] uppercase mb-8 transition-colors"
              >
                <ArrowLeft size={12} /> Back to Journal
              </Link>
              <div className="inline-block bg-primary text-black text-[10px] tracking-[0.25em] uppercase font-bold px-3 py-1.5 mb-5">
                {post.category}
              </div>
              <h1
                className="font-sans font-black text-white uppercase leading-[1] mb-6"
                style={{
              ...
              <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-white/75 text-[11px] tracking-widest uppercase">
                ...
                <span className="flex items-center gap-1.5"><MapPin size={11} className="text-primary" />{post.location}</span>
      ...
      <article className="py-20" style={{ background: "#0a0a0a" }}>
        <div className="container mx-auto px-6 max-w-3xl">
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-white/85 text-xl lg:text-2xl font-light leading-relaxed mb-12 pb-8"
            style={{ borderBottom: "1px solid rgba(221,184,95,0.2)" }}
          >
            {post.excerpt}
          </motion.p>
              ...
              if (block.type === "heading") {
                return (
                  <motion.h2
                    ...
                    className="font-sans font-bold text-white text-2xl lg:text-3xl uppercase tracking-tight pt-6"
                  >
              ...
              if (block.type === "paragraph") {
                return (
                  <motion.p
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true, margin: "-50px" }}
                    className="text-white/75 text-base lg:text-[17px] font-light leading-[1.85]"
                  >
                    {block.text}
                  </motion.p>
                );
              ...
              if (block.type === "quote") {
                return (
                  <motion.blockquote
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true, margin: "-50px" }}
                    className="my-10 pl-6 py-4 border-l-2 border-primary"
                  >
                    <p className="font-serif italic text-white/85 text-xl lg:text-2xl leading-snug">
                      "{block.text}"
                    </p>
                  </motion.blockquote>
                );
              ...
              if (block.type === "image") {
                return (
                  ...
                  >
                    ...
                    {block.caption && (
                      <figcaption className="text-white/45 text-xs uppercase tracking-widest mt-4 text-center font-light">
                        {block.caption}
                      </figcaption>
                    )}
                  </motion.figure>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {post.gallery.map((src, i) => (
                <motion.div
                  ...
                  className="overflow-hidden h-72 group cursor-pointer"
                >
                  <img
                    src={src}
                    alt=""
      ...
      <section className="py-16" style={{
        ...
        borderTop: "1px solid rgba(221,184,95,0.18)",
      }}>
          ...
          <Link href={`/blog/${next.slug}`}>
            <div className="group grid grid-cols-1 md:grid-cols-2 gap-8 cursor-pointer">
              <div className="flex flex-col justify-center">
                ...
                <h3 className="font-sans font-bold text-white text-2xl lg:text-3xl uppercase leading-tight mb-5 group-hover:text-primary transition-colors duration-400">
                  {next.title}
                </h3>
