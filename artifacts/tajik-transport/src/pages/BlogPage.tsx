    ...
    <main className="min-h-screen bg-background text-white selection:bg-primary selection:text-black">
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none"
          style={{ background: "radial-gradient(ellipse at 50% 0%, rgba(221,184,95,0.10) 0%, transparent 60%)" }}
        />
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          ...
          >
            ...
            <h1
              className="font-sans font-black text-white uppercase leading-[0.95] mb-6"
          ...
          <Link href={`/blog/${featured.slug}`}>
            ...
            >
              <div className="relative overflow-hidden h-72 lg:h-[480px]">
                ...
                <div className="absolute top-5 left-5 bg-primary text-black text-[10px] tracking-[0.25em] uppercase font-bold px-3 py-1.5">
                  Featured
                </div>
                <div className="absolute bottom-5 left-5 text-[10px] uppercase tracking-widest text-white/85 bg-black/60 backdrop-blur-sm px-3 py-1.5 border border-white/10">
                  {featured.category}
                </div>
              </div>
              ...
              <div className="flex flex-col justify-center">
                ...
                <p className="text-white/65 text-base font-light leading-relaxed mb-8 max-w-xl">
                  {featured.excerpt}
                </p>
                <div className="flex items-center gap-3 text-primary text-xs tracking-[0.25em] uppercase font-semibold">
                  Read Story
                  <ArrowRight size={14} className="group-hover:translate-x-2 transition-transform duration-400" />
                </div>
              </div>
            </motion.article>
          </Link>
              ...
              >
                <Link href={`/blog/${post.slug}`} className="group block h-full">
                  <div className="relative overflow-hidden h-64">
                    ...
                    <div className="absolute top-4 left-4 text-[9px] uppercase tracking-widest text-primary/90 bg-black/70 backdrop-blur-sm px-2.5 py-1 border border-primary/20">
                      {post.category}
                    </div>
                  </div>
                  ...
                  <div className="p-7 border-t border-white/5 group-hover:border-primary/25 transition-colors duration-400">
                    ...
                    <p className="text-white/55 text-sm font-light leading-relaxed mb-5 line-clamp-3">
                      {post.excerpt}
                    </p>
